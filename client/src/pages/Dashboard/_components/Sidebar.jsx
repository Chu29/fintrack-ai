...
const Sidebar = ({ navigationItems, profile }) => {
  return (
    <aside className="border-b border-dashboard-border-soft bg-dashboard-sidebar px-5 py-6 xl:border-b-0 xl:border-r xl:border-dashboard-border xl:px-6 xl:py-7">
      <div className="flex h-full flex-col gap-6">
        ...
        <nav aria-label="Dashboard navigation" className="grid gap-2 sm:grid-cols-2 xl:grid-cols-1">
        ...
        <div className="grid gap-4 xl:mt-auto">
          <button
            type="button"
            className={cx(ui.action.primary, 'h-13 px-4')}
          >
            New Transaction
          </button>
